...
describe('Service Tests', () => {
  describe('Chord Service', () => {
    let injector: TestBed;
    let service: ChordService;
    let httpMock: HttpTestingController;
    let elemDefault: IChord;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ChordService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Chord(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Chord', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            key: 'BBBBBB',
