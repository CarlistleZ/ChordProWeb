...
import com.carlistlez.presonalteam.repository.ArtistRepository;
...
public class ArtistResourceIT {
    ...
    public void createArtist() throws Exception {
        ...
        assertThat(testArtist.getGenre()).isEqualTo(DEFAULT_GENRE);
        assertThat(testArtist.getLabel()).isEqualTo(DEFAULT_LABEL);
        assertThat(testArtist.getYear()).isEqualTo(DEFAULT_YEAR);
    }
    ...
    public void updateArtist() throws Exception {
        ...
        assertThat(testArtist.getGenre()).isEqualTo(UPDATED_GENRE);
        assertThat(testArtist.getLabel()).isEqualTo(UPDATED_LABEL);
        assertThat(testArtist.getYear()).isEqualTo(UPDATED_YEAR);
    }
